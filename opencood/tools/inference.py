...
def main():
    ...
    result_stat = {0.3: {'tp': [], 'fp': [], 'gt': 0, 'score': [], 'tp_pd': [[],[],[],[]], 'fp_pd': [[],[],[],[]], 'gt_pd': [0,0,0,0], 'score_pd': [[],[],[],[]]},                
                0.5: {'tp': [], 'fp': [], 'gt': 0, 'score': [], 'tp_pd': [[],[],[],[]], 'fp_pd': [[],[],[],[]], 'gt_pd': [0,0,0,0], 'score_pd': [[],[],[],[]]},                
                0.7: {'tp': [], 'fp': [], 'gt': 0, 'score': [], 'tp_pd': [[],[],[],[]], 'fp_pd': [[],[],[],[]], 'gt_pd': [0,0,0,0], 'score_pd': [[],[],[],[]]}}
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            eval_utils.caluclate_partial_tp_fp(pred_box_tensor,
                                    pred_score,
                                    gt_box_tensor,
                                    result_stat,
                                    0.3)
    ...
    ap_50, ap_70, ap_50_1, ap_50_2, ap_50_3, ap_50_4, ap_70_1, ap_70_2, ap_70_3, ap_70_4 = eval_utils.eval_final_results(result_stat,
